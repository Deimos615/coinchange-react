        ...
        <Col md={10}>
          <div className='hero_frm_wrap'>
            <div className='exchange_top_wrap'>
              <div className='echange_lft'>
                <div className='echange_input'>
                  <input type="text" step="0.00000001" value="0.010863" data-listener-added="true" />
                  <select name="fromCurrency" id="fromCurrency" className="pl-0" style={{ maxWidth: '100px' }}>
                    <option value="ZRX">0x (ERC20)</option>
                    <option value="AAVEETH">Aave (ERC20)</option>
                    ...
                    <option value="BUSDTRC">Binance USD (TRC20)</option>
                    ...
                    <option value="BNB">BNB Beacon Chain (BEP2)</option>
                    ...
                    <option value="MANAETH">Decentraland (ERC20)</option>
                    <option value="DOGE">Dogecoin</option>
                    <option value="EOS">EOS</option>
                    <option value="ETH">Ethereum</option>
                    <option value="ETHARBITRUM">Ethereum (Arbitrum)</option>
                    ...
                    <option value="USDTARBITRUM">Tether (Arbitrum)</option>
                    ...
                    <option value="TWTBSC">Trust Wallet Token (BEP20)</option>
                    ...
                    <option value="WBNBBSC">Wrapped BNB (BEP20)</option>
              ...
              <div className="echange_lft echange_rgt">
                <div className="echange_input">
                  <select name="toCurrency" id="toCurrency" className="pl-0" style={{ maxWidth: '100px' }}>
                    <option value="ZRX">0x (ERC20)</option>
                    <option value="AAVEETH">Aave (ERC20)</option>
                    <option value="AVAX">Avalanche (C-Chain)</option>
                    <option value="BAT">Basic Attention (ERC20)</option>
                  ...
                  <input type="text" value="0.1678721" />
                </div>
                <p>1 ETH ≈ 0.06317867 BTC | $279.53</p>
              </div>
            </div>
            <div className='middle_input_wrap'>
              <input type="text" placeholder="Enter Ethereum address" name="address" className="form-control text-white ether_address" required="" />
            </div>
            <div className="middle_inpt_wrap">
              <a className="active" href="/">Fixed Rate (1.0%)</a>
            ...
            <div className="exchange_btn">
              <button type="button" className="btn btn_submit">Exchange Now</button>
            </div>
          </div>
        </Col>
      </div>
        ...
        <div className="row">
          <div className="col-lg-12">
            <div className="common_heading">
              <h2>Why Choose <span>CoinChange ?</span></h2>
              <p>CoinChange takes pride in its ability to be a high end crypto exchange for its customers.</p>
            </div>
          </div>
        </div>
        <div className="row">
          <div className="col-lg-3">
            <div className="feat_box_wrap feat_mt50">
              ...
              <h5>Lowest Fees</h5>
              <p>CoinChange only takes .05% - 1% in fees, while other exchanges can reach 2-5%.</p>
            </div>
          ...
          <div className="col-lg-3">
            <div className="feat_box_wrap">
              <img src={featIcon} alt="Feature icons" className="img-fluid" />
              <h5>No Hassle</h5>
              <p>CoinChange gets right to the point. We won't waste your precious time and will keep you satisfied with our service.</p>
            </div>
            <div className="feat_box_wrap">
              <img src={featIcon} alt="Feature icons" className="img-fluid" />
